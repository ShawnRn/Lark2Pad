...
DMG_ARM64="$RELEASE_DIR/Lark2Pad_${VERSION}_arm64.dmg"
DMG_X86_64="$RELEASE_DIR/Lark2Pad_${VERSION}_x86_64.dmg"
PROJECT_FILE="$PROJECT_DIR/Lark2Pad.xcodeproj"
SCHEME="Lark2Pad"
REMOTE_VERIFY_DIR="$(mktemp -d "${TMPDIR:-/tmp}/lark2pad-release-verify.XXXXXX")"
...
URL_ARM64="https://github.com/ShawnRn/Lark2Pad/releases/download/v$VERSION/Lark2Pad_${VERSION}_arm64.dmg"
URL_X86_64="https://github.com/ShawnRn/Lark2Pad/releases/download/v$VERSION/Lark2Pad_${VERSION}_x86_64.dmg"

REMOTE_ARM64="$REMOTE_VERIFY_DIR/Lark2Pad_${VERSION}_arm64.dmg"
REMOTE_X86_64="$REMOTE_VERIFY_DIR/Lark2Pad_${VERSION}_x86_64.dmg"
...
echo "请执行:"
echo "gh release create \"v$VERSION\" \"$DMG_ARM64\" \"$DMG_X86_64\" --title \"Lark2Pad $VERSION\" --notes \"更新日志...\""
